<template>
  ...
  <div class="container">    
    ...
    <div class="bracket flexDirRow alignCenter">
      ...
      <div class="flex2">
        ...
        <div class="bracket__left flexRow">
            ...
            <div class="bracket__left-matches">
                ...
                <div class="bracket__left-top flexRow groupC">            

                    <div class="bracket__left-top-teams">
                    
                        <div v-for="(game,index) in bracketData.groups[2].games" v-bind:key="index" class="bracket__col flexRow">
                            <div class="bracket__teams">
                ...
                <div class="bracket__left-top flexRow groupB">
                    ...
                    <div v-for="(game,index) in bracketData.groups[3].games" v-bind:key="index" class="bracket__col flexRow">
                        <div class="bracket__teams">
